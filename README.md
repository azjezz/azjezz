...
My name is Saif Eddin, I'm a Senior Engineer [@Bumble](https://bumble.com/), and previously at [@CoopTilleuls](https://les-tilleuls.coop/en), and [@Symfony SAS](https://symfony.com). 
...
- [azjezz/psl](https://github.com/azjezz/psl) ([2.4.0](https://github.com/azjezz/psl/releases/tag/2.4.0), today) - 📚 PHP Standard Library - a modern, consistent, centralized, well-typed, non-blocking set of APIs for PHP programmers
