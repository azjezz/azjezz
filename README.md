...
- [php-standard-library/psalm-plugin](https://github.com/php-standard-library/psalm-plugin) ([1.1.0](https://github.com/php-standard-library/psalm-plugin/releases/tag/1.1.0), today) - Psalm integration for the PHP Standard Library
