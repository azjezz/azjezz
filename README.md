...
- [php-standard-library/mime](https://github.com/php-standard-library/mime) - MIME media types, multipart body construction, content sniffing, S/MIME cryptography, and DKIM signing (3 days ago)

---

#### 🔭 Recent Releases

- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.23.1](https://github.com/carthage-software/mago/releases/tag/1.23.1), today) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
