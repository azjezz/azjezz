...
- [settermjd/send-email-with-sendgrid-and-rust](https://github.com/settermjd/send-email-with-sendgrid-and-rust) - A small project showing how to send email with SendGrid and Rust (5 days ago)
...
- [laminas/automatic-releases](https://github.com/laminas/automatic-releases) ([1.14.1](https://github.com/laminas/automatic-releases/releases/tag/1.14.1), today) - Automated release process for `laminas/` projects, usable as github action
