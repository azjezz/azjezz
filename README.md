...
- [azjezz/psl](https://github.com/azjezz/psl) ([2.6.0](https://github.com/azjezz/psl/releases/tag/2.6.0), 4 days ago) - 📚 PHP Standard Library - a modern, consistent, centralized, well-typed, non-blocking set of APIs for PHP programmers
- [symfony/var-exporter](https://github.com/symfony/var-exporter) ([v6.3.0-RC1](https://github.com/symfony/var-exporter/releases/tag/v6.3.0-RC1), 5 days ago) - Allows exporting any serializable PHP data structure to plain PHP code
