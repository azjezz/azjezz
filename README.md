...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.47.4](https://github.com/carthage-software/mago/releases/tag/1.47.4), 3 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
...
- [symfony/finder](https://github.com/symfony/finder) ([v8.1.5](https://github.com/symfony/finder/releases/tag/v8.1.5), 5 days ago) - Finds files and directories via an intuitive fluent interface
