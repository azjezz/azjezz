...
- [revoltphp/event-loop](https://github.com/revoltphp/event-loop) ([v1.0.1](https://github.com/revoltphp/event-loop/releases/tag/v1.0.1), 6 days ago) - Revolt is a rock-solid event loop for concurrent PHP applications.
