...
- [carthage-software/whim](https://github.com/carthage-software/whim) ([0.2.2](https://github.com/carthage-software/whim/releases/tag/0.2.2), 1 day ago) - The Whim Programming Language
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.47.5](https://github.com/carthage-software/mago/releases/tag/1.47.5), 2 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
