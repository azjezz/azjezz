...
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code. (2 days ago)
- [php-standard-library/mime](https://github.com/php-standard-library/mime) - MIME media types, multipart body construction, content sniffing, S/MIME cryptography, and DKIM signing (5 days ago)
