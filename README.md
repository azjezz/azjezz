...
- [azjezz/discern](https://github.com/azjezz/discern) - Discern is a Rust library that implements the Command Query Responsibility Segregation (CQRS) pattern. (4 weeks ago)
...
- [azjezz/psl](https://github.com/azjezz/psl) ([3.0.0](https://github.com/azjezz/psl/releases/tag/3.0.0), 6 days ago) - 📚 PHP Standard Library - a modern, consistent, centralized, well-typed, non-blocking set of APIs for PHP programmers
