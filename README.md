...
- [symfony/form](https://github.com/symfony/form) ([v5.2.2](https://github.com/symfony/form/releases/tag/v5.2.2), today) - The Form component allows you to easily create, process and reuse HTML forms.
