...
- [php-rust-tools/parser](https://github.com/php-rust-tools/parser) - A handwritten recursive-descent parser for PHP written in Rust, for fun. (3 days ago)
...
- [azjezz/psl](https://github.com/azjezz/psl) ([2.3.0](https://github.com/azjezz/psl/releases/tag/2.3.0), 2 days ago) - 📚 PHP Standard Library - a modern, consistent, centralized, well-typed, non-blocking set of APIs for PHP programmers
- [php-standard-library/psalm-plugin](https://github.com/php-standard-library/psalm-plugin) ([2.1.0](https://github.com/php-standard-library/psalm-plugin/releases/tag/2.1.0), 3 days ago) - Psalm integration for the PHP Standard Library
...
- [davidcole1340/ext-php-rs](https://github.com/davidcole1340/ext-php-rs) ([v0.8.3](https://github.com/davidcole1340/ext-php-rs/releases/tag/v0.8.3), 5 days ago) - Bindings for the Zend API to build PHP extensions natively in Rust.
