...
- [carthage-software/whim](https://github.com/carthage-software/whim) ([0.5.0](https://github.com/carthage-software/whim/releases/tag/0.5.0), today) - The Whim Programming Language
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.47.6](https://github.com/carthage-software/mago/releases/tag/1.47.6), 4 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
