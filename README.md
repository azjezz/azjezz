...
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) ([v1.1.10](https://github.com/denzyldick/phanalist/releases/tag/v1.1.10), 1 day ago) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code.
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.45.0](https://github.com/carthage-software/mago/releases/tag/1.45.0), 2 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
