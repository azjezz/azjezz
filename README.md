...
- [laravel/serializable-closure](https://github.com/laravel/serializable-closure) - Laravel Serializable Closure provides an easy way to serialize closures in PHP. (2 days ago)
...
- [vimeo/psalm](https://github.com/vimeo/psalm) ([4.10.0](https://github.com/vimeo/psalm/releases/tag/4.10.0), 5 days ago) - A static analysis tool for finding errors in PHP applications
