...
- [neutomic/neu](https://github.com/neutomic/neu) - Neu - a modern, concurrent, fast framework for web development (4 days ago)
...
- [azjezz/psl](https://github.com/azjezz/psl) ([2.0.0-rc1](https://github.com/azjezz/psl/releases/tag/2.0.0-rc1), 6 days ago) - 📚 PHP Standard Library - a modern, consistent, centralized, well-typed, non-blocking set of APIs for PHP programmers.
...
- [php-standard-library/psalm-plugin](https://github.com/php-standard-library/psalm-plugin) ([2.0.0](https://github.com/php-standard-library/psalm-plugin/releases/tag/2.0.0), 6 days ago) - Psalm integration for the PHP Standard Library
