...
- [azjezz/http-normalizer](https://github.com/azjezz/http-normalizer) -  (2 days ago)
...
- [Ocramius/DoctrineBatchUtils](https://github.com/Ocramius/DoctrineBatchUtils) ([2.2.0](https://github.com/Ocramius/DoctrineBatchUtils/releases/tag/2.2.0), 1 day ago) - :loop: A set of utilities to operate with Doctrine ORM&#39;s batch processing techniques
- [azjezz/http-normalizer](https://github.com/azjezz/http-normalizer) ([v1.1.0](https://github.com/azjezz/http-normalizer/releases/tag/v1.1.0), 2 days ago) - 
- [hhvm/hhvm-autoload](https://github.com/hhvm/hhvm-autoload) ([v3.2.0](https://github.com/hhvm/hhvm-autoload/releases/tag/v3.2.0), 4 days ago) - Autoload classes, functions, enums, constants, and typedefs on HHVM
- [hhvm/hsl-experimental](https://github.com/hhvm/hsl-experimental) ([v4.76.1](https://github.com/hhvm/hsl-experimental/releases/tag/v4.76.1), 5 days ago) - Experimental features for the Hack Standard Library
