...
- [settermjd/send-email-with-sendgrid-and-rust](https://github.com/settermjd/send-email-with-sendgrid-and-rust) - A small project showing how to send email with SendGrid and Rust (2 weeks ago)
...
- [revoltphp/event-loop](https://github.com/revoltphp/event-loop) ([v0.2.5](https://github.com/revoltphp/event-loop/releases/tag/v0.2.5), 3 days ago) - Revolt is a rock-solid event loop for concurrent PHP applications.
- [laminas/automatic-releases](https://github.com/laminas/automatic-releases) ([1.14.1](https://github.com/laminas/automatic-releases/releases/tag/1.14.1), 1 week ago) - Automated release process for `laminas/` projects, usable as github action
