...
- [symfony/finder](https://github.com/symfony/finder) ([v8.1.0](https://github.com/symfony/finder/releases/tag/v8.1.0), 5 days ago) - Finds files and directories via an intuitive fluent interface
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) ([v0.1.30](https://github.com/denzyldick/phanalist/releases/tag/v0.1.30), 6 days ago) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code.
