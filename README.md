...
- [carthage-software/fennec-playground](https://github.com/carthage-software/fennec-playground) - An experimental playground for the Fennec toolchain, showcasing its capabilities through WebAssembly. (4 days ago)
...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([0.0.5](https://github.com/carthage-software/mago/releases/tag/0.0.5), 1 day ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
