...
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) ([v1.0.1](https://github.com/denzyldick/phanalist/releases/tag/v1.0.1), today) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code.
