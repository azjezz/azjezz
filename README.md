...
- [symfony/var-exporter](https://github.com/symfony/var-exporter) ([v6.3.2](https://github.com/symfony/var-exporter/releases/tag/v6.3.2), 3 days ago) - Allows exporting any serializable PHP data structure to plain PHP code
