...
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) ([v1.1.10](https://github.com/denzyldick/phanalist/releases/tag/v1.1.10), 3 weeks ago) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code.
