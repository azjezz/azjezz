...
- [denzyldick/phanalist](https://github.com/denzyldick/phanalist) ([v0.1.31](https://github.com/denzyldick/phanalist/releases/tag/v0.1.31), 1 day ago) - Performant static analyzer for PHP, which is extremely easy to use. It helps you catch common mistakes in your PHP code.
